...
namespace API.Entities {
    ...
    {
        DRAFTED, SUBMITTED, REVIEWING, REJECTED, MINOR_REVISION, MAJOR_REVISION, APPROVED, PUBLISHED
    }
    ...
    public class Article: BaseEntity {
        ...
        public virtual ICollection<ReviewRequest> ReviewRequests { get; set; } = null!;
    ...
    public class Reference: BaseEntity {
        ...
        [ForeignKey(nameof(ReferenceArticleId))]
