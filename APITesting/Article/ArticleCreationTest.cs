    ...
    public class ArticleCreationTest {
        ...
        public async Task TestCreateArticleUsingTextSuccefully() {
            ...
            var data = new Dictionary<string, dynamic>
            {
                ...
                { "conclusion", "Fusce quis consequat diam. Nunc vel convallis velit, et venenatis lacus. Etiam congue, eros vitae vehicula finibus, sem mi gravida eros, vitae pretium felis ligula eget arcu. Nunc commodo neque eu metus gravida, ac mollis massa eleifend. Vestibulum a mauris eget quam aliquet gravida. Etiam luctus erat ut ligula scelerisque, ut elementum est venenatis. Nulla rutrum venenatis dui vel venenatis."},
                { "referenceIds", new Collection<int> { } },
            ...
            var response = await client.PostAsync(Route.Host + Route.BaseUrl + Route.Article + "/text", body);
        ...
        public async Task TestCreateArticleUsingFileSuccessfully() {
            ...
            HttpClient client = new HttpClient();
            await client.PostAsync(Route.Host + Route.BaseUrl + Route.Article, requestBody);
        }
    }
}